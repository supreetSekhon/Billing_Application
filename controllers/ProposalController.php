...
use app\models\ProposalsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ProposalController implements the CRUD actions for Proposals model.
 */
class ProposalController extends Controller
{
    ...
    {
        $searchModel = new ProposalsSearch();
    ...
    {
        if (($model = Proposals::findOne(['id' => $id])) !== null) {
            return $model;
        }
